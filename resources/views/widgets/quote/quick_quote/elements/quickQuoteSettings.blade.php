<div :class="['row front', isPresent ? 'd-none' : 'd-flex']">
    ...
    <div class="col-12 col-md-4 mb-5">
       <button @click="residualValueByTermAndMile">residualValueByTermAndMile</button>
    ...
    <div class="col-12 col-md-8">
        ...
        <div class="d-flex justify-content-between align-items-center  mb-3">
            ...
            <input type="number" v-model="msrp">
{{--            <h5 class='text-right' v-text="'$' + msrp"></h5>--}}
        </div>
        <div class="d-flex justify-content-between align-items-center  mb-3">
            <h4 class="card-title">Residual Value</h4>
            <input type="number" v-model="residualValuePercent">
...
{{--            <h5 class='text-right' v-text="'$' + sellingPrice"></h5>--}}
        ...
        <div class="d-flex justify-content-between align-items-center  mb-3">
            ...
            <input type="number" v-model="moneyFactor">
